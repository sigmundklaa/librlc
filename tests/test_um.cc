         ...
         "[um][rx]")
{
        ...
        REQUIRE(timer_ctx.armed(fx.get()->rx.t_reassembly.gtimer) ==
               true);
         ...
         "[um][loopback]")
{
        ...
        REQUIRE(timer_ctx.armed(peer_b.get()->rx.t_reassembly.gtimer) ==
               true);
        timer_ctx.fire(peer_b.get()->rx.t_reassembly.gtimer);
